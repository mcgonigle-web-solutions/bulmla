...
class TplBulmlaHelper
{
	...
	{
		HTMLHelper::_('stylesheet', 'bulmla.css', ['version' => 'auto', 'relative' => true]);

		// Check for a custom CSS file
		$userCss = JPATH_SITE . '/templates/' . self::template() . '/css/custom.css';
	...
	{
		HTMLHelper::_('script', 'bulmla.js', ['version' => 'auto', 'relative' => true]);
	}
