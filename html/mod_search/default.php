...
if ($width)
{
	$moduleclass_sfx .= ' ' . 'input' . $module->id;
...
<div class="search<?php echo $moduleclass_sfx; ?>">
	<form action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-inline" role="search">
		<?php
			...
			$output .= '<input name="searchword" id="mod-search-searchword' . $module->id . '" maxlength="' . $maxlength . '"  class="inputbox is-ful search-query " type="search"' . $width;
			...
			if ($button) :
				if ($imagebutton) :
					...
					$btn_output = ' <button class="button is-primary" onclick="this.form.searchword.focus();">' . $button_text . '</button>';
				endif;
